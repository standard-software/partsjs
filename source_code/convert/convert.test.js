...
const test_execute_convert = (parts) => {
  ...
  describe('test_execute_convert', () => {
    ...
    const test_valueToString = () => {
      it('test_valueToString', () => {
        ...
        checkEqual('16',        valueToString(0o20));
        ...
        checkEqual(false,   isThrown(() => valueToString(32, 2)));
        checkEqual(true,    isThrown(() => valueToString(32, 2.5)));
        checkEqual(true,    isThrown(() => valueToString(32, 1)));
        checkEqual(false,   isThrown(() => valueToString(32, 36)));
        checkEqual(true,    isThrown(() => valueToString(32, 37)));
    ...
    const test_valueToNumber = () => {
      it('test_valueToNumber', () => {
        ...
        checkEqual(NaN,       valueToNumber('a123'));
    ...
    const test_valueToInteger = () => {
      it('test_valueToInteger', () => {
        // Integer
        ...
        checkEqual(NaN,       valueToInteger('a123'));
        ...
        checkEqual(0,         valueToInteger('.14'));
