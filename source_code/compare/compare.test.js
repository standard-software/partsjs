...
const test_execute_compare = (parts) => {
  ...
  describe(test_execute_compare.name, () => {
    ...
    const test_equal_object = () => {
      describe(test_equal_object.name, () => {
    ...
    const test_equal_array = () => {
      describe(test_equal_array.name, () => {
    ...
    const test_equal_regexp = () => {
      describe(test_equal_regexp.name, () => {
    ...
    const test_equalDeep_object = () => {
      describe(test_equalDeep_object.name, () => {
    ...
    const test_equalDeep_object_array_mix = () => {
      describe(test_equalDeep_object_array_mix.name, () => {
    ...
    const test_equalDeep_object_CircularReference = () => {
      describe(test_equalDeep_object_CircularReference.name, () => {
    ...
    const test_equalDeep_array = () => {
      describe(test_equalDeep_array.name, () => {
    ...
    const test_equalDeep_array_CircularReference = () => {
      describe(test_equalDeep_array_CircularReference.name, () => {
    ...
    const test_equalDeep_date = () => {
      describe(test_equalDeep_date.name, () => {
    ...
    const test_equalDeep_regexp = () => {
      describe(test_equalDeep_regexp.name, () => {
    ...
    const test_equalDeep_map = () => {
      describe(test_equalDeep_map.name, () => {
    ...
    const test_equalDeep_map_object_array = () => {
      describe(test_equalDeep_map_object_array.name, () => {
    ...
    const test_equalDeep_map_CircularReference = () => {
      describe(test_equalDeep_map_CircularReference.name, () => {
    ...
    const test_equalDeep_set = () => {
      describe(test_equalDeep_set.name, () => {
    ...
    const test_equalDeep_set_object_array = () => {
      describe(test_equalDeep_set_object_array.name, () => {
    ...
    const test_equalDeep_set_CircularReference = () => {
      describe(test_equalDeep_set_CircularReference.name, () => {
    ...
    const test_initialValue = () => {
      describe(test_initialValue.name, () => {
    ...
    const test_matchSomeIndex = () =>{
      describe(test_matchSomeIndex.name, () => {
        it(test_matchSomeIndex.name, () => {
          checkEqual(0,
