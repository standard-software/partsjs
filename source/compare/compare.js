...
export const {
  _or,
  _match, _matchValue, _initialValue, _indexOfMatch, _allMatch, _someMatch,
  _matchSome, _matchSomeValue, _indexOfMatchSome, _allMatchSome, _someMatchSome,
  _matchAll, _matchAllValue, _indexOfMatchAll, _allMatchAll, _someMatchAll,
  _includes, _includesSome, _includesAll,
  _equal, _equalDeep,
} = compareJs;
