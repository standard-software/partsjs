...
const test_execute_root = (parts) => {
  ...
  describe(test_execute_root.name, () => {
    ...
    const test_clone_object = () =>{
      describe(test_clone_object.name, () => {
    ...
    const test_clone_array = () =>{
      describe(test_clone_array.name, () => {
    ...
    const test_clone_function = () => {
      describe(test_clone_function.name, () => {
    ...
    const test_clone_regexp = () => {
      describe(test_clone_regexp.name, () => {
    ...
    const test_cloneDeep_object = () =>{
      describe(test_cloneDeep_object.name, () => {
    ...
    const test_cloneDeep_array = () =>{
      describe(test_cloneDeep_array.name, () => {
    ...
    const test_cloneDeep_object_array_mix = () => {
      describe(test_cloneDeep_object_array_mix.name, () => {
    ...
    const test_cloneDeep_date = () => {
      describe(test_cloneDeep_date.name, () => {
    ...
    const test_cloneDeep_regExp = () => {
      describe(test_cloneDeep_regExp.name, () => {
    ...
    const test_cloneDeep_function = () => {
      describe(test_cloneDeep_function.name, () => {
    ...
    const test_cloneDeep_moment = () => {
      describe(test_cloneDeep_moment.name, () => {
    ...
    const test_cloneDeep_symbol = () => {
      describe(test_cloneDeep_symbol.name, () => {
    ...
    const test_cloneDeep_map = () => {
      describe(test_cloneDeep_map.name, () => {
    ...
    const test_cloneDeep_set = () => {
      describe(test_cloneDeep_set.name, () => {
    ...
    const test_cloneDeep_CircularReference = () => {
      describe(test_cloneDeep_CircularReference.name, () => {
