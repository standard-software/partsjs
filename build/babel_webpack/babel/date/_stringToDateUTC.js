...
var _stringToDate = require("./__stringToDate.js");
...
var _stringToDateUTC = function _stringToDateUTC(str, format) {
  ...
  return (0, _stringToDate.__stringToDate)(str, format, null, sourceDate, rule);
};

exports._stringToDateUTC = _stringToDateUTC;
_stringToDateUTC.rule = _stringToDate.__stringToDate.rule;
var _default = {
