...
exports["default"] = exports.__stringToDate = void 0;
...
var __stringToDate = function __stringToDate(str, format) {
  var timezoneOffset = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : new Date().getTimezoneOffset();
  var sourceDate = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : (0, _Year2._Year)(true);
...
exports.__stringToDate = __stringToDate;
__stringToDate.rule = _stringToDateRule.__stringToDateRule;
var _default = {
  __stringToDate: __stringToDate
};
