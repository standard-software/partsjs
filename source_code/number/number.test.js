...
const test_execute_number = (parts) => {
  ...
  describe(test_execute_number.name, () => {
    ...
    const test_isMultiples = () => {
      describe(test_isMultiples.name, () => {
